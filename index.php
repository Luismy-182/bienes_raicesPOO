...
incluirTemplate('header', $inicio=true, $baner=true);
...
?>
    ...
    <?php include_once 'includes/templates/anuncios.php'?>
    ...
    <section class="imagen-contacto"> 
        ...
        <p>llena el formulario de contacto y te contactaremos a la brevedad</p>
